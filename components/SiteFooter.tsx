            ...
            <div className="me-split" style={{ gap: "clamp(40px,6vw,90px)", paddingBottom: "clamp(48px,6vw,72px)", borderBottom: "1px solid rgba(247,247,244,0.1)" }}>
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "14px", marginTop: "26px" }}>
                  ...
                  <a href="https://www.facebook.com/maisonsdexcellence" target="_blank" rel="noopener" className="me-soc" aria-label="Maisons d'Excellence sur Facebook" style={{ width: "40px", height: "40px", borderRadius: "50%", border: "1px solid rgba(247,247,244,0.25)", color: "rgba(247,247,244,0.8)", display: "inline-flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
