      ...
      <main data-screen-label="Accueil">
          ...
          <section className="me-hero" style={{ position: "relative", minHeight: "max(680px,100vh)", display: "flex", flexDirection: "column" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden", background: "#111412" }}>
              <div data-slide="0" className="me-slide" role="img" aria-label="Maison individuelle construite dans l'Ain par Maisons d'Excellence" style={{ position: "absolute", inset: "0", opacity: "1", backgroundImage: "url('/photos/bandeau-accueil-1.webp')", backgroundSize: "cover", backgroundPosition: "center" }}></div>
              <div data-slide="1" className="me-slide" role="img" aria-label="Maison individuelle construite dans l'Ain par Maisons d'Excellence" style={{ position: "absolute", inset: "0", opacity: "0", backgroundImage: "url('/photos/bandeau-accueil-2.webp')", backgroundSize: "cover", backgroundPosition: "center" }}></div>
              <div data-slide="2" className="me-slide" role="img" aria-label="Maison individuelle construite dans l'Ain par Maisons d'Excellence" style={{ position: "absolute", inset: "0", opacity: "0", backgroundImage: "url('/photos/bandeau-accueil-3.webp')", backgroundSize: "cover", backgroundPosition: "center" }}></div>
              <div data-slide="3" className="me-slide" role="img" aria-label="Maison individuelle construite dans l'Ain par Maisons d'Excellence" style={{ position: "absolute", inset: "0", opacity: "0", backgroundImage: "url('/photos/bandeau-accueil-4.webp')", backgroundSize: "cover", backgroundPosition: "center" }}></div>
            </div>
            <div data-veil="radial" style={{ position: "absolute", inset: "0", background: "radial-gradient(120% 92% at 50% 44%,rgba(11,13,12,0.125) 0%,rgba(11,13,12,0.22) 58%,rgba(11,13,12,0.343) 100%)" }}></div>
            <div data-veil="linear" style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(11,13,12,0.277) 0%,rgba(11,13,12,0.057) 26%,rgba(11,13,12,0.086) 60%,rgba(11,13,12,0.297) 100%)" }}></div>
            ...
            <div data-hero-col="" style={{ position: "relative", flex: "1 1 auto", minHeight: "0", width: "100%", maxWidth: "1200px", margin: "0 auto", padding: "clamp(104px,12vw,150px) clamp(20px,5vw,64px) clamp(18px,2.4vw,32px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
              ...
              <div data-reveal="" data-delay="440" className="me-hero-cta" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", marginTop: "clamp(26px,3vw,38px)" }}>
                ...
                <a href="/nos-modeles" onClick={goModeles} className="me-btn" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", boxSizing: "border-box", minWidth: "242px", height: "54px", padding: "0 26px", borderRadius: "100px", border: "1px solid rgba(199,166,110,0.6)", background: "rgba(17,20,18,0.28)", color: "#F7F7F4", fontSize: "14px", fontWeight: "600", letterSpacing: "0.02em", backdropFilter: "blur(6px)" }} style-hover="background:rgba(199,166,110,0.18);border-color:rgba(199,166,110,0.95);transform:translateY(-3px);">Découvrir nos modèles</a>
              </div>
            ...
            <div className="me-hero-bar" style={{ position: "relative", flex: "none", width: "100%", height: "60px", marginBottom: "clamp(16px,2vw,28px)", padding: "0 clamp(20px,5vw,64px)", display: "grid", gridTemplateColumns: "minmax(0,1fr) auto minmax(0,1fr)", alignItems: "center", gap: "20px" }}>
              <div className="me-hero-social" style={{ justifySelf: "start", display: "inline-flex", alignItems: "center", gap: "14px" }}><a href={avisUrl} target="_blank" rel="noopener noreferrer" data-reveal="" data-delay="560" className="me-hero-avis me-pastille-google" aria-label="Voir les avis Google de Maisons d'Excellence" style={{ flex: "none", display: "inline-flex", alignItems: "center", gap: "11px", textDecoration: "none", background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.08)", borderRadius: "999px", padding: "8px 16px", boxShadow: "0 6px 18px -6px rgba(0,0,0,0.35)", transition: "transform .3s cubic-bezier(.16,.84,.44,1),box-shadow .3s" }}><svg width="22" height="22" viewBox="0 0 48 48" aria-hidden="true" style={{ flex: "none", display: "block" }}><path fill="#4285F4" d="M45.12 24.5c0-1.56-.14-3.06-.4-4.5H24v8.51h11.84c-.51 2.75-2.06 5.08-4.39 6.64v5.52h7.11c4.16-3.83 6.56-9.47 6.56-16.17z"></path><path fill="#34A853" d="M24 46c5.94 0 10.92-1.97 14.56-5.33l-7.11-5.52c-1.97 1.32-4.49 2.1-7.45 2.1-5.73 0-10.58-3.87-12.31-9.07H4.34v5.7C7.96 41.07 15.4 46 24 46z"></path><path fill="#FBBC05" d="M11.69 28.18C11.25 26.86 11 25.45 11 24s.25-2.86.69-4.18v-5.7H4.34C2.85 17.09 2 20.45 2 24s.85 6.91 2.34 9.88l7.35-5.7z"></path><path fill="#EA4335" d="M24 10.75c3.23 0 6.13 1.11 8.41 3.29l6.31-6.31C34.91 4.18 29.93 2 24 2 15.4 2 7.96 6.93 4.34 14.12l7.35 5.7c1.73-5.2 6.58-9.07 12.31-9.07z"></path></svg><span style={{ display: "flex", flexDirection: "column", lineHeight: "1.25" }}><span style={{ display: "flex", alignItems: "center", gap: "6px" }}><span className="me-note" style={{ fontWeight: "700", fontSize: "14px", color: "#202124" }}>5,0</span><span className="me-etoiles" style={{ color: "#FBBC04", fontSize: "13px", letterSpacing: "1px" }}>★★★★★</span></span><span className="me-nb-avis" style={{ fontSize: "12px", color: "#5F6368", whiteSpace: "nowrap" }}>{avisCount} avis Google</span></span></a><a href="https://www.instagram.com/maisonsdexcellence" target="_blank" rel="noopener" data-reveal="" data-delay="580" className="me-hero-insta" aria-label="Maisons d'Excellence sur Instagram" style={{ flex: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", borderRadius: "50%", border: "1px solid rgba(247,247,244,0.32)", color: "rgba(247,247,244,0.86)", textDecoration: "none", transition: "transform .3s cubic-bezier(.16,.84,.44,1),border-color .3s,color .3s" }} style-hover="border-color:#F7F7F4;color:#F7F7F4;transform:translateY(-2px);"><svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" aria-hidden="true"><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0m0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06zm0 3.678a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324M12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8m7.846-10.405a1.441 1.441 0 0 1-2.88 0 1.44 1.44 0 0 1 2.88 0"></path></svg></a></div>
              ...
              <div className="me-g3" style={{ gap: "clamp(16px,1.8vw,26px)" }}>
                <div data-reveal="" className="me-card" style={{ borderRadius: "6px", overflow: "hidden", background: "#111412" }}>
                  <div style={{ position: "relative", overflow: "hidden", aspectRatio: "3/4" }}>
                    <img loading="lazy" className="me-zoom" src="/photos/maison-contemporaine-etage-porche.webp" alt="Maison contemporaine à étage avec porche d'entrée construite dans l'Ain" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                ...
                <div data-reveal="" data-delay="120" className="me-card" style={{ borderRadius: "6px", overflow: "hidden", background: "#111412" }}>
                  <div style={{ position: "relative", overflow: "hidden", aspectRatio: "3/4" }}>
                    <img loading="lazy" className="me-zoom" src="/photos/maison-plain-pied-en-l.webp" alt="Maison traditionnelle de plain-pied en L, toiture tuile, construite dans l'Ain" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,transparent 45%,rgba(11,13,12,0.85) 100%)" }}></div>
                ...
                <div data-reveal="" data-delay="240" className="me-card" style={{ borderRadius: "6px", overflow: "hidden", background: "#111412" }}>
                  <div style={{ position: "relative", overflow: "hidden", aspectRatio: "3/4" }}>
                    <img loading="lazy" className="me-zoom" src="/photos/maison-monopente-garage-independant.webp" alt="Maison contemporaine à toit monopente avec garage indépendant, construite dans l'Ain" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,transparent 45%,rgba(11,13,12,0.85) 100%)" }}></div>
          ...
          <section style={{ position: "relative", overflow: "hidden", color: "#F7F7F4", padding: "clamp(90px,13vw,170px) 0" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img loading="lazy" data-parallax="0.10" src="/photos/chantier-gros-oeuvre-brique.webp" alt="Chantier de construction de maison individuelle suivi par Maisons d'Excellence" style={{ width: "100%", height: "100%", objectFit: "cover", transform: "scale(1.08)", willChange: "transform" }} /></div>
