    ...
    <>
      <main data-screen-label="Réalisations">
          <section style={{ position: "relative", minHeight: "clamp(420px,48vh,580px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            ...
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img src="/photos/maison-familiale-etage.png" alt="Maison individuelle livrée par Maisons d'Excellence dans l'Ain" style={{ width: "100%", height: "100%", objectFit: "cover", animation: "meKb 18s ease-out forwards" }} /></div>
            ...
            <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 clamp(20px,5vw,64px)" }}>
              <div className="me-g2" style={{ gap: "clamp(16px,2vw,28px)" }}>
                <div data-reveal="" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", minHeight: "clamp(320px,40vw,460px)" }}>
                  <img className="me-zoom" src="/photos/maison-contemporaine-etage-porche.png" alt="Maison contemporaine à étage avec porche d'entrée et garage double" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                ...
                <div data-reveal="" data-delay="120" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", minHeight: "clamp(320px,40vw,460px)" }}>
                  <img className="me-zoom" src="/photos/maison-traditionnelle-etage.png" alt="Maison traditionnelle à étage, enduit ton pierre, construite dans l'Ain" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                  <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(11,13,12,0) 40%,rgba(11,13,12,0.86) 100%)" }}></div>
              ...
              <div className="me-g3" style={{ gap: "clamp(16px,2vw,28px)", marginTop: "clamp(16px,2vw,28px)" }}>
                <div data-reveal="" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", aspectRatio: "4/5" }}>
                  <img className="me-zoom" src="/photos/maison-etage-terrain-en-pente.png" alt="Maison à étage bâtie sur terrain en pente avec terrasses en béton" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                ...
                <div data-reveal="" data-delay="100" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", aspectRatio: "4/5" }}>
                  <img className="me-zoom" src="/photos/maison-monopente-garage-independant.png" alt="Maison contemporaine à toit monopente avec garage indépendant" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                  <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(11,13,12,0) 45%,rgba(11,13,12,0.85) 100%)" }}></div>
              ...
              <div className="me-split" style={{ gap: "clamp(16px,2vw,28px)", marginTop: "clamp(16px,2vw,28px)" }}>
                <div data-reveal="" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", minHeight: "clamp(300px,34vw,420px)" }}>
                  <img className="me-zoom" src="/photos/maison-plain-pied-en-l.png" alt="Maison de plain-pied en L, toiture tuile, construite dans l'Ain" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                  <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(11,13,12,0) 45%,rgba(11,13,12,0.85) 100%)" }}></div>
                ...
                <div data-reveal="" data-delay="120" className="me-card me-projbig" style={{ position: "relative", borderRadius: "8px", overflow: "hidden", minHeight: "clamp(300px,34vw,420px)" }}>
                  <img className="me-zoom" src="/photos/maison-plain-pied-contemporaine.png" alt="Maison de plain-pied contemporaine, toiture ardoisée, garage intégré" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover" }} />
                  <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(11,13,12,0) 45%,rgba(11,13,12,0.85) 100%)" }}></div>
