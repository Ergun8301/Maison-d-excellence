    ...
    <>
      <main data-screen-label="Contact">
          ...
          <section style={{ position: "relative", minHeight: "clamp(420px,48vh,580px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img src="/photos/bureau-meximieux-vitrine-bandeau.png" alt="Les vitrines du bureau Maisons d'Excellence, 6 rue de Genève à Meximieux" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 46%", animation: "meKb 18s ease-out forwards" }} /></div>
            ...
            <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 clamp(20px,5vw,64px)" }}>
              ...
              <div className="me-split" style={{ gap: "clamp(28px,3.6vw,56px)", alignItems: "stretch" }}>
                ...
                <div data-reveal="" style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <a href="https://wa.me/33615191647" target="_blank" rel="noopener" className="me-link" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "15px", padding: "20px 0", borderTop: "1px solid rgba(17,20,18,0.14)", color: "#111412" }} style-hover="color:#25D366;">
