    ...
    <>
      <main data-screen-label="Contact">
          ...
          <section style={{ position: "relative", minHeight: "clamp(420px,48vh,580px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img src="/photos/bureau-meximieux-vitrine-bandeau.webp" alt="Les vitrines du bureau Maisons d'Excellence, 6 rue de Genève à Meximieux" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 46%", animation: "meKb 18s ease-out forwards" }} /></div>
