      ...
      <main data-screen-label="Contact">
          ...
          <section style={{ position: "relative", minHeight: "clamp(480px,66vh,600px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            ...
            <div style={{ position: "relative", width: "100%", maxWidth: "1440px", margin: "0 auto", padding: "clamp(104px,11vw,128px) clamp(20px,5vw,64px) clamp(44px,5.4vw,76px)" }}>
              ...
              <a href="/contact#contact" onClick={goContactForm} data-reveal="" data-delay="340" className="me-cue me-scroll" style={{ position: "absolute", right: "clamp(20px,5vw,64px)", bottom: "clamp(30px,4vw,58px)", display: "flex", flexDirection: "column", alignItems: "center", gap: "clamp(12px,1.4vw,18px)", textDecoration: "none", color: "#D3B27A" }} style-hover="color:#FFFFFF;">
          ...
          <section style={{ background: "#FFFFFF", borderBottom: "1px solid rgba(17,20,18,0.08)", padding: "22px 0" }}>
            <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 clamp(20px,5vw,64px)", display: "flex", flexWrap: "wrap", gap: "10px 26px", alignItems: "center" }}>
              ...
              <a href="/contact#contact" onClick={goContactForm} className="me-link" style={{ textDecoration: "none", color: "#111412", fontSize: "13.5px", fontWeight: "600" }} style-hover="color:#2E5A49;">Nous écrire</a>
              <a href="/contact#nous-trouver" onClick={goTrouver} className="me-link" style={{ textDecoration: "none", color: "#111412", fontSize: "13.5px", fontWeight: "600" }} style-hover="color:#2E5A49;">Coordonnées &amp; plan</a>
            ...
            <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 clamp(20px,5vw,64px)" }}>
              ...
              <div className="me-split" style={{ gap: "clamp(28px,3.6vw,56px)", alignItems: "stretch" }}>
                ...
                <div data-reveal="" style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <a href="mailto:contact@maisons-dexcellence.fr" className="me-link" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "15px", padding: "20px 0", borderTop: "1px solid rgba(17,20,18,0.14)", color: "#111412" }} style-hover="color:#2E5A49;">
                    <span style={{ width: "38px", height: "38px", flex: "none", borderRadius: "50%", background: "#111412", color: "#9CC4B2", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "15px" }}>✉</span>
                    <span><span style={{ display: "block", fontSize: "10.5px", letterSpacing: "0.16em", textTransform: "uppercase", color: "#77807A", marginBottom: "3px" }}>Email</span><span style={{ fontSize: "16.5px", fontWeight: "500" }}>contact@maisons-dexcellence.fr</span></span>
                  </a>
                  ...
                  <a href="/zone-intervention" onClick={goZone} className="me-link" style={{ textDecoration: "none", display: "flex", alignItems: "flex-start", gap: "15px", padding: "20px 0", borderTop: "1px solid rgba(17,20,18,0.14)", borderBottom: "1px solid rgba(17,20,18,0.14)", color: "#111412" }} style-hover="color:#2E5A49;">
                    <span style={{ width: "38px", height: "38px", flex: "none", borderRadius: "50%", background: "#111412", color: "#9CC4B2", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "15px" }}>⌂</span>
