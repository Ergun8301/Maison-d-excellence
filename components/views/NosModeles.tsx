    ...
    <>
      <main data-screen-label="Nos modèles">
          <section style={{ position: "relative", minHeight: "clamp(420px,48vh,580px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img src="/photos/maison-contemporaine-bardage-bois.jpg" alt="Maison contemporaine à étage, béton et bardage bois ajouré, volets coulissants" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 42%", animation: "meKb 18s ease-out forwards" }} /></div>
