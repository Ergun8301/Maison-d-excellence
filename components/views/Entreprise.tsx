    ...
    <>
      <main data-screen-label="L'entreprise">
          <section style={{ position: "relative", minHeight: "clamp(480px,66vh,600px)", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
            <div style={{ position: "absolute", inset: "0", overflow: "hidden" }}><img src="/photos/entreprise-bandeau.webp" alt="Conception des plans d'une maison individuelle sur mesure par Maisons d'Excellence" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 64%", animation: "meKb 18s ease-out forwards" }} /></div>
            ...
            <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 clamp(20px,5vw,64px)" }}>
              ...
              <div className="me-g2" style={{ gap: "clamp(16px,2vw,26px)", marginTop: "clamp(44px,6vw,70px)" }}>
                <div data-reveal="" className="me-card" style={{ background: "#FFFFFF", border: "1px solid rgba(17,20,18,0.08)", borderRadius: "10px", overflow: "hidden" }}>
                  <div style={{ position: "relative", aspectRatio: "16/9", overflow: "hidden" }}><img loading="lazy" className="me-zoom" src="/photos/chantier-gros-oeuvre-brique.webp" alt="Élévation des murs en brique sur un chantier de maison individuelle dans l'Ain" style={{ width: "100%", height: "100%", objectFit: "cover" }} /></div>
                ...
                <div data-reveal="" data-delay="120" className="me-card" style={{ background: "#FFFFFF", border: "1px solid rgba(17,20,18,0.08)", borderRadius: "10px", overflow: "hidden" }}>
                  <div style={{ position: "relative", aspectRatio: "16/9", overflow: "hidden" }}><img loading="lazy" className="me-zoom" src="/photos/charpente-fermette-bois.webp" alt="Charpente en bois posée sur une maison neuve : entretoises, contreventement et pannes" style={{ width: "100%", height: "100%", objectFit: "cover" }} /></div>
                  <div style={{ padding: "clamp(26px,3vw,38px)" }}>
